...
var seq__12792_12796 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__12793_12797 = null;
var count__12794_12798 = (0);
var i__12795_12799 = (0);
while(true){
if((i__12795_12799 < count__12794_12798)){
var str_12800 = cljs.core._nth.call(null,chunk__12793_12797,i__12795_12799);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_12800})));
...
var temp__5720__auto___12805 = cljs.core.seq.call(null,seq__12792_12796);
if(temp__5720__auto___12805){
var seq__12792_12806__$1 = temp__5720__auto___12805;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__12792_12806__$1)){
var c__4556__auto___12807 = cljs.core.chunk_first.call(null,seq__12792_12806__$1);
var G__12808 = cljs.core.chunk_rest.call(null,seq__12792_12806__$1);
var G__12809 = c__4556__auto___12807;
var G__12810 = cljs.core.count.call(null,c__4556__auto___12807);
var G__12811 = (0);
...
var str_12812 = cljs.core.first.call(null,seq__12792_12806__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_12812})));
...
var script__$1 = (function (){var G__12821 = script;
goog.object.set(G__12821,"type","text/javascript");

goog.object.set(G__12821,"onload",onload);

goog.object.set(G__12821,"onreadystatechange",onload);

return G__12821;
})();
if((opt_sourceText == null)){
var G__12822 = script__$1;
goog.object.set(G__12822,"src",src);

return G__12822;
} else {
var G__12823 = script__$1;
goog.dom.setTextContent(G__12823,opt_sourceText);
...
var path_12824 = goog.debugLoader_.getPathFromDeps_(src);
goog.object.remove(goog.debugLoader_.written_,path_12824);

goog.object.remove(goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_12824)].join(''));
} else {
var path_12825 = goog.object.get(goog.dependencies_.nameToPath,src);
goog.object.remove(goog.dependencies_.visited,path_12825);

goog.object.remove(goog.dependencies_.written,path_12825);

goog.object.remove(goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_12825)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__12826 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__12827 = repl;
(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__12827);

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__12826);
}})()})));
}));
